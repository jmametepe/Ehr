...
class LabTechnicianDiagnosis extends StatefulWidget {

  @override
  _LabTechnicianDiagnosisState createState() => _LabTechnicianDiagnosisState();
}

class _LabTechnicianDiagnosisState extends State<LabTechnicianDiagnosis> {
  @override
