...
class LabTechnicianPermissions extends StatefulWidget {

  @override
  _LabTechnicianPermissionsState createState() => _LabTechnicianPermissionsState();
}

class _LabTechnicianPermissionsState extends State<LabTechnicianPermissions> {
  @override
