...
class LabTechnicianTreatments extends StatefulWidget {

  @override
  _LabTechnicianTreatmentsState createState() => _LabTechnicianTreatmentsState();
}

class _LabTechnicianTreatmentsState extends State<LabTechnicianTreatments> {
  @override
