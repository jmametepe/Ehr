...
class DoctorDiagnosis extends StatefulWidget {

  @override
  _DoctorDiagnosisState createState() => _DoctorDiagnosisState();
}

class _DoctorDiagnosisState extends State<DoctorDiagnosis> {
  @override
