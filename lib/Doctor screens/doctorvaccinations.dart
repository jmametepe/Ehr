...
class DoctorVaccinations extends StatefulWidget {


  @override
  _DoctorVaccinationsState createState() => _DoctorVaccinationsState();
}

class _DoctorVaccinationsState extends State<DoctorVaccinations> {
  @override
