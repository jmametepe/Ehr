...
class DoctorTreatments extends StatefulWidget {

  @override
  _DoctorTreatmentsState createState() => _DoctorTreatmentsState();
}

class _DoctorTreatmentsState extends State<DoctorTreatments> {
  @override
