...
class DoctorPermissions extends StatefulWidget {

  @override
  _DoctorPermissionsState createState() => _DoctorPermissionsState();
}

class _DoctorPermissionsState extends State<DoctorPermissions> {
  @override
