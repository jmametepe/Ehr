...
class VaccineOfficerPatients extends StatefulWidget {

  @override
  _VaccineOfficerPatientsState createState() => _VaccineOfficerPatientsState();
}

class _VaccineOfficerPatientsState extends State<VaccineOfficerPatients> {
  @override
