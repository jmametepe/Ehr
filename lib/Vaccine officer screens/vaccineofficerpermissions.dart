...
class VaccineOfficerPermissions extends StatefulWidget {

  @override
  _VaccineOfficerPermissionsState createState() => _VaccineOfficerPermissionsState();
}

class _VaccineOfficerPermissionsState extends State<VaccineOfficerPermissions> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: new AppBar(
          ...
          title: Text('Permissions', style: TextStyle(color: Colors.black),),
        ),
        body: StreamBuilder(
