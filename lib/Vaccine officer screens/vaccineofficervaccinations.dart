...
import 'vaccineofficerdiagnosis.dart';
...
class VaccineOfficerVaccinations extends StatefulWidget {


  @override
  _VaccineOfficerVaccinationsState createState() => _VaccineOfficerVaccinationsState();
}

class _VaccineOfficerVaccinationsState extends State<VaccineOfficerVaccinations> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: new AppBar(
          ...
          title: Text('Vaccinations', style: TextStyle(color: Colors.black),),
        ),
        body: StreamBuilder(
