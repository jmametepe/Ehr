...
class VaccineOfficerProfile extends StatefulWidget {
  @override
  _VaccineOfficerProfileState createState() => _VaccineOfficerProfileState();
}

class _VaccineOfficerProfileState extends State<VaccineOfficerProfile> {
