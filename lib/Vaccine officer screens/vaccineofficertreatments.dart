...
class VaccineOfficerTreatments extends StatefulWidget {

  @override
  _VaccineOfficerTreatmentsState createState() => _VaccineOfficerTreatmentsState();
}

class _VaccineOfficerTreatmentsState extends State<VaccineOfficerTreatments> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: new AppBar(
          ...
          title: Text('Treatments', style: TextStyle(color: Colors.black),),
        ),
        body: StreamBuilder(
