...
class VaccineOfficerHomePage extends StatefulWidget {
  @override
  _VaccineOfficerHomePageState createState() => _VaccineOfficerHomePageState();
}

class _VaccineOfficerHomePageState extends State<VaccineOfficerHomePage> {
  bool loading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return loading? Loading():Scaffold(
        ...
        appBar: new AppBar(
          ...
          title: Text('Vaccine Officer', style: TextStyle(color: Colors.black),),
          actions: <Widget>[
