...
class VaccineOfficerTest extends StatefulWidget {
  @override
  _VaccineOfficerTestState createState() => _VaccineOfficerTestState();
}

class _VaccineOfficerTestState extends State<VaccineOfficerTest> {
  @override
